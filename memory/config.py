...
def add_ateacher_config(cfg):
    ...
    _C.SOLVER.TOP_K = 1
    _C.SOLVER.PER = 50
    _C.SOLVER.pseudo_th = 0.5
    _C.SOLVER.BEST_CHECKPOINTER=True 
    ...
    _C.SEMISUPNET.BBOX_CONTRA_THRESHOLD = 0.7
    ...
    _C.SEMISUPNET.CON_LOSS_WEIGHT = 0.1
    _C.SEMISUPNET.ITR_MEM_UPDATE = 5000
